<div class="col-md-12">
    <div class="form-reg-cliente">
        <div class="wrap">
            ...
            <form action="../../../almacen-prototipo/data/dataCliente/eliminarCliente.php" class="formulario" name="formulario_registro_cliente" method="GET">
                <div>
                    ...
                    <input type="submit" id="btn-submit" value="Inhabilitar">
                </div>
            </form>
        </div>
    </div>
