...
<div class="form-reg-cliente">
  <div class="wrap">
    <form action="" class="formulario" name="formulario_registro_cliente" method="get">
      <div>
        ...
        <div class="input-group">
          <input type="text" id="direccion-empresa" name="direccion-empresa">
          <label class="label" for="direccion-empresa">Direccion:</label>
        </div>
